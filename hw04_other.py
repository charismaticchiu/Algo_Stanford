...
if(__name__=="__main__"):
  graph1=parse_graph("SCC.txt",True);  	#parse the graph in reverse order   - row adjacency list
  graph2=parse_graph("SCC.txt",False); 	#parse the grpah in straight order  - row adjacency list
